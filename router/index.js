...
router.post('/send', function(req, res, next) {
    ...
    request.post({
        ...
        <form id="form" method="post" action="https://payment-stage.allpay.com.tw/Cashier/AioCheckOut/V2">
            <input type="hidden" name="MerchantID" value="${form1.MerchantID}">
            <input type="hidden" name="MerchantTradeNo" value="${form1.MerchantTradeNo}">
            <input type="hidden" name="MerchantTradeDate" value="${form1.MerchantTradeDate}">
            <input type="hidden" name="PaymentType" value="${form1.PaymentType}">
            <input type="hidden" name="TotalAmount" value="${form1.TotalAmount}">
            <input type="hidden" name="TradeDesc" value="${form1.TradeDesc}">
            <input type="hidden" name="ItemName" value="${form1.ItemName}">
            <input type="hidden" name="ReturnURL" value="${form1.ReturnURL}">
            <input type="hidden" name="ChoosePayment" value="${form1.ChoosePayment}">
